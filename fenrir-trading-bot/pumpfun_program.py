...
INITIALIZE_DISCRIMINATOR = base58.b58decode(b"initialize")[:8]
BUY_DISCRIMINATOR = base58.b58decode(b"buy")[:8]
SELL_DISCRIMINATOR = base58.b58decode(b"sell")[:8]
...
class PumpFunProgram:
    ...
    def decode_bonding_curve(self, account_data: bytes) -> Optional[BondingCurveState]:
        ...
        try:
            ...
            print(f"Failed to decode bonding curve: {e}")
            return None
...
class TokenLaunchDetector:
    ...
    def parse_create_event(
        ...
        try:
            ...
            print(f"Failed to parse create event: {e}")
            return None
